...
1. Explain what a token is used for.
  - tokens are used to restrict access to data and the user who knows the token can access the information. For example, sign up and login. 
2. What steps can you take in your web apps to keep your data secure?
  - creating protected routes and using tokens to send authentication headers with our api calls 
3. Describe how web servers work.
`- web server store, process and deliver web pages to clients
